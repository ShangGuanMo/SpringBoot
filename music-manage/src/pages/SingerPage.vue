<template>
  <div class="table">
    <div class="container">
      ...
      <el-table ref="multipleTable" size="mini" border style="width: 100%" height="640px" :data="data" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" width="150" align="center">
          <template slot-scope="scope" class="el-btn">
