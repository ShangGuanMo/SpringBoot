...
//获取推荐歌单
export const getSongListRecommend = (userId) => get(`songListRecommend?userId=${userId}`)
// 获取歌单类型
...
// 取消收藏歌曲 type: 0 代表歌曲， 1 代表歌单
export const deleteCollection = (params) => get(`collection/delete`, params)
// 获取歌曲收藏状态
export const getCollectionStatus = (params) => post(`collection/status`, params)
...
// 返回模糊歌名的歌曲
export const getLikeSongOfName = (keywords) => get(`song/name/detail?name=${keywords}`)
// 下载音乐
