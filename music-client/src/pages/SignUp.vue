...
<div class="signUp-page">
  ...
  <div class="signUp">
    ...
    <el-form :model="registerForm" status-icon :rules="rules" ref="registerForm" label-width="70px" class="demo-ruleForm">
      ...
      <el-form-item prop="phoneNum" label="手机" required="true">
      ...
      <el-form-item prop="location" label="地区" required="true">
...
export default {
  ...
  methods: {
    SignUp () {
      ...
      params.append('introduction', this.registerForm.introduction || "我是个好人")
