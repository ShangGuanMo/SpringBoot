<template>
  <div>
    ...
    <ul class="popular" v-for="(item, index) in commentList" :key="index">
      <li>
        <div class="popular-img" @click="goPage(item.userId)">
...
export default {
  ...
  methods: {
    // 前往用户主页
    goPage(anotherUserId){
      if(anotherUserId != this.userId){
        this.$store.commit('setAnotherUserId', anotherUserId)
        this.$store.commit('setVisit', true)
      }
      console.log(this.anotherUserId + "+" + this.visit + "+" + this.userId)
