...
//        String pic = "/img/avatorImages/user.jpg";
    ...
    public Object allSinger() {
        return new SuccessMessage<List<Singer>>("所有歌手", singerService.allSinger()).getMessage();
    }
    ...
    public Object singerOfName(HttpServletRequest req) {
        ...
        return new SuccessMessage<List<Singer>>(name, singerService.singerOfName(name)).getMessage();
    }
    ...
    public Object singerOfSex(HttpServletRequest req) {
        ...
        return new SuccessMessage<List<Singer>>(sex + "歌手", singerService.singerOfSex(Integer.parseInt(sex))).getMessage();
    }
