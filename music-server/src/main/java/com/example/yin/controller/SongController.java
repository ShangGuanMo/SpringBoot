...
public class SongController {
    ...
    public Object songOfId(HttpServletRequest req) {
        String id = req.getParameter("id");
        return new SuccessMessage<Song>(null, songService.songOfId(Integer.parseInt(id))).getMessage();
    }
    ...
    public Object likeSongOfName(HttpServletRequest req) {
        ...
        return new SuccessMessage<List<Song>>(name, songService.likeSongOfName('%' + name + '%')).getMessage();
    }
